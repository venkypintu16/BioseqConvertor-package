...
The last function is protein_to_cdna which converts the protein sequence into DNA sequence which actually doesn't produce same DNA as The first one we used, because each protein can be encoded by different codons.
But i stongly belive, this package is useful for bioinformatics analysis and molecular biology research.
